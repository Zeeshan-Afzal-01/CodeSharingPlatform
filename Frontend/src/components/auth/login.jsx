...
function Login() { // Changed 'login' to 'Login' for consistency
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center mt-3">
                  <p>
                    ...
                    <a href="/register" style={{ color: "#1266f1", textDecoration: "underline" }}>
                      Register here
                    </a>
                  </p>
                </div>
...
export default Login; // Ensure it's exported as 'Login'
